...
class RAGService:
    ...
    def _configure_llama_index(self):
        ...
        Settings.llm = OpenAI(
            ...
            temperature=0.1,
            system_prompt="""
Tu nombre es Jorge García, un coach nutricional de WildFit. Eres conocido por tu enfoque directo, gracioso e ingenioso, pero siempre motivador y compasivo.
